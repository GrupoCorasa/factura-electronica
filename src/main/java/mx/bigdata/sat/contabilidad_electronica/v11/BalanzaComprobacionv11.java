...
import mx.bigdata.sat.ce.v11.ce_balanza_comprobacion.schema.Balanza;
...
public class BalanzaComprobacionv11 {

    private static final String XSLT = "/xslt/ce/v11/ce_balanza_comprobacion/BalanzaComprobacion_1_1.xslt";
    private static final String[] XSD = new String[]{
            "/xsd/ce/v11/ce_balanza_comprobacion/BalanzaComprobacion_1_1.xsd"
    };

    private static final String XML_HEADER = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>";

    private static final String BASE_CONTEXT = "mx.bigdata.sat.ce.v11.ce_balanza_comprobacion.schema";
    ...
    public static final ImmutableMap<String, String> PREFIXES =
            ImmutableMap.of("http://www.sat.gob.mx/esquemas/ContabilidadE/1_1/BalanzaComprobacion", "BCE",
    ...
    public BalanzaComprobacionv11(Balanza balanza, String... contexts) throws Exception {
        this.context = getContext(contexts);
