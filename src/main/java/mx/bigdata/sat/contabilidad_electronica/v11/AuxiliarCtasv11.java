...
import mx.bigdata.sat.ce.v11.ce_auxiliar_ctas.schema.AuxiliarCtas;
...
public class AuxiliarCtasv11 {

    private static final String XSLT = "/xslt/ce/v11/ce_auxiliar_ctas/AuxiliarCtas_1_1.xslt";
    private static final String[] XSD = new String[]{
            "/xsd/ce/v11/ce_auxiliar_ctas/AuxiliarCtas_1_1.xsd"
    };

    private static final String XML_HEADER = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>";

    private static final String BASE_CONTEXT = "mx.bigdata.sat.ce.v11.ce_auxiliar_ctas.schema";
    ...
    public static final ImmutableMap<String, String> PREFIXES =
            ImmutableMap.of("www.sat.gob.mx/esquemas/ContabilidadE/1_1/AuxiliarCtas", "AuxiliarCtas",
    ...
    final AuxiliarCtas document;

    public AuxiliarCtasv11(InputStream in, String... contexts) throws Exception {
        this.context = getContext(contexts);
        this.document = load(in);
    }

    public AuxiliarCtasv11(AuxiliarCtas auxiliar_ctas, String... contexts) throws Exception {
        this.context = getContext(contexts);
        this.document = copy(auxiliar_ctas);
    }
    ...
    public AuxiliarCtas sellarComprobante(PrivateKey key, X509Certificate cert) throws Exception {
        sellar(key, cert);
        return doGetAuxiliarCtas();
    }
    ...
    public void guardar(OutputStream out) throws Exception {
        ...
        m.setProperty(Marshaller.JAXB_SCHEMA_LOCATION, "www.sat.gob.mx/esquemas/ContabilidadE/1_1/AuxiliarCtas " + "http://www.sat.gob.mx/esquemas/ContabilidadE/1_1/AuxiliarCtas/AuxiliarCtas_1_1.xsd");
    ...
    public static AuxiliarCtas newComprobante(InputStream in) throws Exception {
        return load(in);
    }
...
//	}
    ...
    AuxiliarCtas doGetAuxiliarCtas() throws Exception {
    ...
    private static AuxiliarCtas load(InputStream source, String... contexts)
            throws Exception {
        JAXBContext context = getContext(contexts);
        try {
            Unmarshaller u = context.createUnmarshaller();
            return (AuxiliarCtas) u.unmarshal(source);
        } finally {
            source.close();
        }
    }
    ...
    // Defensive deep-copy
    private AuxiliarCtas copy(AuxiliarCtas auxiliar_ctas) throws Exception {
        DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
        dbf.setNamespaceAware(true);
        DocumentBuilder db = dbf.newDocumentBuilder();
        Document doc = db.newDocument();
        Marshaller m = context.createMarshaller();
        m.marshal(auxiliar_ctas, doc);
        Unmarshaller u = context.createUnmarshaller();
        return (AuxiliarCtas) u.unmarshal(doc);
    }
