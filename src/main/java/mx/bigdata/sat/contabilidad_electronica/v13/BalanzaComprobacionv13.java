...
import mx.bigdata.sat.ce.v13.ce_balanza_comprobacion.schema.Balanza;
...
public class BalanzaComprobacionv13 {

    private static final String XSLT = "/xslt/ce/v13/ce_balanza_comprobacion/BalanzaComprobacion_1_2.xslt";
    private static final String[] XSD = new String[]{
            "/xsd/ce/v13/ce_balanza_comprobacion/BalanzaComprobacion_1_3.xsd"
    };

    private static final String XML_HEADER = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>";

    private static final String BASE_CONTEXT = "mx.bigdata.sat.ce.v13.ce_balanza_comprobacion.schema";
    ...
    public static final ImmutableMap<String, String> PREFIXES =
            ImmutableMap.of("http://www.sat.gob.mx/esquemas/ContabilidadE/1_3/BalanzaComprobacion", "BCE",
    ...
    final Balanza document;

    public BalanzaComprobacionv13(InputStream in, String... contexts) throws Exception {
        this.context = getContext(contexts);
        this.document = load(in);
    }

    public BalanzaComprobacionv13(Balanza balanza, String... contexts) throws Exception {
        this.context = getContext(contexts);
    ...
    public void guardar(OutputStream out) throws Exception {
        ...
        m.setProperty(Marshaller.JAXB_SCHEMA_LOCATION, "www.sat.gob.mx/esquemas/ContabilidadE/1_3/BalanzaComprobacion " + "http://www.sat.gob.mx/esquemas/ContabilidadE/1_3/BalanzaComprobacion/BalanzaComprobacion_1_3.xsd");
...
//	}
    ...
    Balanza doGetBalanza() throws Exception {
    ...
    private static Balanza load(InputStream source, String... contexts)
            throws Exception {
        JAXBContext context = getContext(contexts);
        try {
            Unmarshaller u = context.createUnmarshaller();
            return (Balanza) u.unmarshal(source);
        } finally {
            source.close();
        }
    }
    ...
    // Defensive deep-copy
    private Balanza copy(Balanza balanza) throws Exception {
        ...
        Unmarshaller u = context.createUnmarshaller();
        return (Balanza) u.unmarshal(doc);
    }
