package mx.bigdata.sat.contabilidad_electronica.v13;

import com.google.common.base.Joiner;
import com.google.common.collect.ImmutableMap;
import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import mx.bigdata.sat.ce.v13.ce_auxiliar_folios.schema.RepAuxFol;
...
public class AuxiliarFoliosv13 {
    private static final String XSLT = "/xslt/ce/v13/ce_auxiliar_folios/AuxiliarFolios_1_2.xslt";
    private static final String[] XSD = new String[]{
            "/xsd/ce/v13/ce_auxiliar_folios/AuxiliarFolios_1_3.xsd"
    };

    private static final String XML_HEADER = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>";

    private static final String BASE_CONTEXT = "mx.bigdata.sat.ce.v13.ce_auxiliar_folios.schema";
    ...
    public static final ImmutableMap<String, String> PREFIXES =
            ImmutableMap.of("www.sat.gob.mx/esquemas/ContabilidadE/1_1/AuxiliarFolios", "RepAux",
    ...
    final RepAuxFol document;

    public AuxiliarFoliosv13(InputStream in, String... contexts) throws Exception {
        this.context = getContext(contexts);
        this.document = load(in);
    }

    public AuxiliarFoliosv13(RepAuxFol balanza, String... contexts) throws Exception {
        this.context = getContext(contexts);
    ...
    public RepAuxFol sellarComprobante(PrivateKey key, X509Certificate cert) throws Exception {
        sellar(key, cert);
        return doGetRepAuxFol();
    }
    ...
    public void guardar(OutputStream out) throws Exception {
        ...
        m.setProperty(Marshaller.JAXB_SCHEMA_LOCATION, "www.sat.gob.mx/esquemas/ContabilidadE/1_1/AuxiliarFolios " + "http://omawww.sat.gob.mx/esquemas/ContabilidadE/1_1/AuxiliarFolios/AuxiliarFolios_1_2.xsd");
    ...
    public static RepAuxFol newComprobante(InputStream in) throws Exception {
        return load(in);
    }
...
//	}
    ...
    RepAuxFol doGetRepAuxFol() throws Exception {
    ...
    private static RepAuxFol load(InputStream source, String... contexts)
            throws Exception {
        JAXBContext context = getContext(contexts);
        try {
            Unmarshaller u = context.createUnmarshaller();
            return (RepAuxFol) u.unmarshal(source);
        } finally {
            source.close();
        }
    }
    ...
    // Defensive deep-copy
    private RepAuxFol copy(RepAuxFol balanza) throws Exception {
        ...
        Unmarshaller u = context.createUnmarshaller();
        return (RepAuxFol) u.unmarshal(doc);
    }
