...
import mx.bigdata.sat.ce.v13.ce_polizas_periodo.schema.Polizas;
...
public class PolizasPeriodov13 {

    private static final String XSLT = "/xslt/ce/v13/ce_polizas_periodo/PolizasPeriodo_1_2.xslt";
    private static final String[] XSD = new String[]{
            "/xsd/ce/v13/ce_polizas_periodo/PolizasPeriodo_1_3.xsd"
    };

    private static final String XML_HEADER = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>";

    private static final String BASE_CONTEXT = "mx.bigdata.sat.ce.v13.ce_polizas_periodo.schema";
    ...
    public static final ImmutableMap<String, String> PREFIXES =
            ImmutableMap.of("http://www.sat.gob.mx/esquemas/ContabilidadE/1_3/PolizasPeriodo", "PLZ",
    ...
    public PolizasPeriodov13(InputStream in, String... contexts) throws Exception {
        this.context = getContext(contexts);
        this.document = load(in);
    }

    public PolizasPeriodov13(Polizas polizas, String... contexts) throws Exception {
        this.context = getContext(contexts);
    ...
    public void guardar(OutputStream out) throws Exception {
        ...
        m.setProperty(Marshaller.JAXB_SCHEMA_LOCATION, "www.sat.gob.mx/esquemas/ContabilidadE/1_3/PolizasPeriodo " + "http://www.sat.gob.mx/esquemas/ContabilidadE/1_3/PolizasPeriodo/PolizasPeriodo_1_3.xsd");
