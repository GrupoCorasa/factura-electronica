...
import mx.bigdata.sat.ce.v13.ce_catalogo_cuentas.schema.Catalogo;
...
public final class CuentasContablesv13 {

    private static final String XSLT = "/xslt/ce/v13/ce_catalogo_cuentas/CatalogoCuentas_1_2.xslt";

    private static final String[] XSD = new String[]{
            "/xsd/ce/v13/ce_catalogo_cuentas/CatalogoCuentas_1_3.xsd"
    };

    private static final String XML_HEADER = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>";

    private static final String BASE_CONTEXT = "mx.bigdata.sat.ce.v13.ce_catalogo_cuentas.schema";
    ...
    public static final ImmutableMap<String, String> PREFIXES =
            ImmutableMap.of("http://www.sat.gob.mx/esquemas/ContabilidadE/1_3/CatalogoCuentas", "catalogocuentas",
                    "http://www.w3.org/2001/XMLSchema-instance", "xsi");

    // ,"http://www.sat.gob.mx/esquemas/ContabilidadE/1_3/CatalogoCuentas", "catalogocuentas"
    ...
    public CuentasContablesv13(InputStream in, String... contexts) throws Exception {
        this.context = getContext(contexts);
        this.document = load(in);
    }

    public CuentasContablesv13(Catalogo catalogo, String... contexts) throws Exception {
        this.context = getContext(contexts);
    ...
    public void guardar(OutputStream out) throws Exception {
        ...
        m.setProperty(Marshaller.JAXB_SCHEMA_LOCATION, "www.sat.gob.mx/esquemas/ContabilidadE/1_3/CatalogoCuentas " + "http://www.sat.gob.mx/esquemas/ContabilidadE/1_3/CatalogoCuentas/CatalogoCuentas_1_3.xsd");
