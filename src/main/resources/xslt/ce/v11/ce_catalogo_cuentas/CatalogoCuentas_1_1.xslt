...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:catalogocuentas="
www.sat.gob.mx/esquemas/ContabilidadE/1_1/CatalogoCuentas">
    ...
    <xsl:template match="/">|<xsl:apply-templates select="/catalogocuentas:Catalogo"/>||
    </xsl:template>
